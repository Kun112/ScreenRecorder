...
public class ScreenRecorder {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_ERROR:
                    ...
                    if (mRecorderCallback != null) {
                        mRecorderCallback.onStop((Throwable) msg.obj);
                    }
                    release();
                    break;
            }
    ...
    private void writeSampleData(int track, MediaCodec.BufferInfo buffer, ByteBuffer encodedData) {
        ...
        if (buffer.size == 0 && !eos) {
            ...
            if (!eos && mRecorderCallback != null) {
                mRecorderCallback.onRecording(buffer.presentationTimeUs);
            }
        }
        if (encodedData != null) {
